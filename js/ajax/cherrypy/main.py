...
#===================== CORS OPTION ROUTES ===========================
	...
	dispatcher.connect('user_options', '/userss/:user_id', controller = optionsController, action = 'OPTIONS', conditions = dict(method = ['OPTIONS']))
	...
	dispatcher.connect('rec_options', '/recommendations/:user_id', controller = optionsController, action = 'OPTIONS', conditions = dict(method = ['OPTIONS']))
	dispatcher.connect('recs_options', '/recommendations/', controller = optionsController, action = 'OPTIONS', conditions = dict(method = ['OPTIONS']))
