...
#===================== RESET ROUTES ===========================
	#POST reset
	dispatcher.connect('post_reset','/reset/', controller = resetController, action = 'RESET_ALL_MOVIES', conditions = dict(method = ['POST']))
	#PUT reset
	dispatcher.connect('put_reset','/reset/:movie_id', controller = resetController, action = 'RESET_MOVIE_BY_ID', conditions = dict(method = ['PUT']))
